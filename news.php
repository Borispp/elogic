	...
	<body>
		<div class="wrapper">
			...
			<section class="section -news">
				<div class="base-col">
					<h3 class="news__header">La statia cosmica internationala s-a stricat WC.</h3>
					<p class="news__signature">01 Octombrie 2015 la 20:15</p>
					<img src="./images/news.png" alt="news" class="news__img">
					<div class="news__text">
						<p class="news__head-text">In luna mai al anului 2008 la Statia cosmica internationala s-a sticat WC. Pentru reparatie astronautii au fost nevoiti sa paraseasca SCI si sa iasa in cosmos deschis. Reparatia a durat citeva zile.</p>
						<p class="news__paragraph">Facem concluzii:</p>
						<ol class="news__conclusions">
							<li>Alegerea canalizatiei - este o intrebare seriasa.</li>
							<li>Tehnica complicata este buna si comoda - pina nu se strica.</li>
							<li>Acesta nu era EcoLogic.</li>
						</ol>
						<p class="news__paragraph">Canalizatia trebuie de facut o data - simpla si durabila. In ceia ce priveste longivitatea, constructiile din beton stau secole - si in apa, si pe mlateni, si in pamint inghetat.</p>
					</div>
				</div>
			</section>
			<!-- BLOCK 7 -->
