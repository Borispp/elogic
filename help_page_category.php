...
<html lang="ro">
	...
	<body>
		...
		<!-- HEADER -->
			...
			<!-- BLOCK 1 -->
			<section class="section -cleaning_system" style="padding-bottom: 180px">
				<div class="base-col">
					<h1 class="headline-1 h1_var2">Intrebari in privinta instalarii</h1>
				</div>
			</section>
			<!-- BLOCK 2 DETAILS -->
			<section class="section -list_installation">
				<div class="base-col">
					<div class="install_details">
						<span class="detail__head">Instalarea</span>
						<a href="#">Marimea proiectului?</a>
						<a href="#">Livrarea?</a>
						<a href="#">Montarea?</a>
						<a href="#">Regulamentul montarii?</a>
						<a href="#">Care este anotimpul potrivit pentru montarea proiectului?</a>
						<a href="#">Termenul montarii?</a>
					</div>
				</div>
			</section>
			<!-- BLOCK 7 -->
